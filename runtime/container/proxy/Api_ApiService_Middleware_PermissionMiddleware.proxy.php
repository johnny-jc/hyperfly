...
class PermissionMiddleware extends Base implements MiddlewareInterface
{
    ...
    {
        $adminRole = RoleAdminActiveRecord::where('admin_id', '=', $adminId)->with(['getRole' => function ($query) {
    ...
    {
        $rolePermission = RolePermissionActiveRecord::whereIn('role_id', $roleIds)->get()->toArray();
